...
class SliderController extends Controller
{
    //
        ...
        $data['pluginjs'] = array();
        $data['js'] = array('ajaxfileupload.js','jquery.form.min.js','sliderstaff.js', 'userfunction.js');
        $data['funinit'] = array('Slider.init()');
        return view('backend.pages.staffmain.slider', $data);
    }
    ...
    public function addslider(Request $request) {
        ...
        if ($request->isMethod('post')) {
            ...
            if ($result) {
                ...
                $return['redirect'] = route('staff-slider');
            }else{
                $return['status'] = 'error';
        ...
        return view('backend.pages.staffmain.addslider', $data);
    }
    ...
    public function emailImages(Request $request) {
        ...
        if ($request->isMethod('post')) {
            ...
            if ($result) {
                ...
                $return['jscode'] = '$(".submitbtn:visible").attr("disabled","disabled");';
                $return['redirect'] = route('staff-email-images');
            }else{
                $return['status'] = 'error';
                $return['message'] = 'Something goes to wrong.Please try again';
            }
        ...
        return view('backend.pages.staffmain.emailImages', $data);
    }
