    ...
    var e = {
        ...
        i = function(i) {
            ...
            return _inherits(n, Component), _createClass(n, [{
                ...
                value: function() {
                    var e = this;
                    this.wrapper = document.createElement("div"), t(this.wrapper).addClass("select-wrapper " + this.options.classes), this.$el.before(t(this.wrapper)), this.wrapper.appendChild(this.el), this.el.disabled && this.wrapper.classList.add("disabled"), this.$selectOptions = this.$el.children("option, optgroup"), this.dropdownOptions = document.createElement("ul"), this.dropdownOptions.id = "select-options-" + M.guid(), t(this.dropdownOptions).addClass("sl2_ul_drpdwn dropdown-content select-dropdown " + (this.isMultiple ? "multiple-select-dropdown" : "")), this.$selectOptions.length && this.$selectOptions.each(function(i) {
                        if (t(i).is("option")) {
                            var n = void 0;
                    ...
                    if (this.$el.before(i[0]), !this.el.disabled) {
                        ...
                        n.onOpenEnd = function(i) {
                            ...
                            t(e.dropdownOptions).find(".selected").addClass('active');
                ...
                value: function(e, i, n) {
                    var s = i.disabled ? "disabled " : "",
                        ...
                        a = this.isMultiple ? '<label><input type="checkbox"' + s + '"/><span class="sl2_drpdwn">' + i.innerHTML + "</span></label>" : i.innerHTML,
                        r = t("<li></li>"),
                        l = t("<span></span>");
