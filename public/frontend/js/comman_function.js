...
//            Toastr.init('warning', 'Some fields are missing!.', '');
        ...
        highlight: function (element) { // hightlight error inputs
//            $(element)
//                    .closest('.form-group,.form-control').addClass('is-invalid'); // set error class to the control group
        },
        unhighlight: function (element) { // revert the change done by hightlight
//            $(element)
//                    .closest('.form-group,.form-control').removeClass('is-invalid'); // set error class to the control group
        },
        success: function (label) {
//            label
//                    .closest('.form-group,.form-control').removeClass('is-invalid'); // set success class to the control group
        ...
        submitHandler: function (form) {
            $('#loader').show();
            $(".submitform:visible").val("Please Wait...");
            $(".submitform:visible").attr("disabled","disabled");
            $(".submitbtn:visible").attr("disabled","disabled");
            $(".submitbtnregister:visible").attr("disabled","disabled");
            $(".submitbtnregister:visible").val("Please Wait ....");
            if (typeof submitCallback !== 'undefined' && typeof submitCallback == 'function') {
                submitCallback(form);
            } else {
                handleAjaxFormSubmit(form);
