var Cselist = function () {
    ...
    var list = function () {
        ...
        var columnWidth = {};
         ...
         var arrList = {
             'tableID': '#cse-allocattion-cso-datatable',
             'ajaxURL': baseurl + "cso-cse-allocation-ajaxAction",
             'ajaxAction': 'get-cse-list-datatable',
             'postData': dataArr,
             'hideColumnList': [],
             'defaultSortColumn': 1,
    ...
    var viewcse =function(){
        var cseId = $("#cseId").val();
        var dataArr = {"cseId":cseId};
        var columnWidth = {};

         var arrList = {
             'tableID': '#cse-view-datatable',
             'ajaxURL': baseurl + "cso-cse-allocation-ajaxAction",
             'ajaxAction': 'get-cse-view-datatable',
             'postData': dataArr,
             'hideColumnList': [],
             'defaultSortColumn': 1,
             'defaultSortOrder': 'asc',
    ...
    handleFormValidateWithMsg(form, rules, messages, function (form) {
        ...
        $('body').on("change","#country",function(){
            ...
            $.ajax({
                ...
                url: baseurl + "investoredit-admin-ajaxAction",
                data: {'action': 'changecountry','id':val},
                success: function(data) {
                    var  output = JSON.parse(data);
                    var temp_html = '';
