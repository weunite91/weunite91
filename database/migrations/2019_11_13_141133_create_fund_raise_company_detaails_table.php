...
class CreateFundRaiseCompanyDetaailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('fund_raiser_company_details', function (Blueprint $table) {
            $table->bigIncrements('id');            
            $table->integer('user_id');
            $table->bigInteger('min_investment');
            $table->bigInteger('max_investment');
            $table->bigInteger('min_investment_accepated');
            ...
            $table->integer('team_mem_deg1');
            $table->integer('team_mem_deg2')->nullable();
            $table->integer('team_mem_deg3')->nullable();
            $table->integer('team_mem_deg4')->nullable();
    ...
    {
        Schema::dropIfExists('fund_raiser_company_details');
    }
}
