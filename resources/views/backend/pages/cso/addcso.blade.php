        ...
        <div class="page-content">
            <div class="page-bar">
                <div class="page-title-breadcrumb">
                    <div class=" pull-left">
                        <div class="page-title">Add Customer Support Officer</div>
                    </div>
                    <ol class="breadcrumb page-breadcrumb pull-right">
                        <li><i class="fa fa-home"></i>&nbsp;<a class="parent-item" href="{{ route("admin-dashborad") }}">Home</a>&nbsp;<i class="fa fa-angle-right"></i>
                        </li>
                        <li><a class="parent-item" href="{{ route("cso-list") }}">CSO List</a>&nbsp;<i class="fa fa-angle-right"></i></li>
           ...
           <div class="row">
                        <div class="col-md-12 col-sm-12">
                            <div class="card card-box">
                                <div class="card-head">
                                    <header>Add Customer Support Officer</header>

                                </div>
                                <div class="card-body " id="bar-parent">
                                    <form method="post" id='addcsoform' >@csrf
                                        <div class="row">
                                            <div class="col-6">
