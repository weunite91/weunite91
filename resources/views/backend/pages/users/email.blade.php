 ...
 <!-- start page content -->
    ...
    <div class="col-md-12">
        <div class="card card-box">
            <div class="card-head">
                <header>Pending Email Verify Profile</header>
            </div>
            <div class="card-body ">
                {{ csrf_field() }}
                <div class="table-scrollable">
                    <table class="table table-hover table-checkable order-column full-width" id="email-datatable">
                        <thead>
                            <tr>
                                <th class="center">#</th>
