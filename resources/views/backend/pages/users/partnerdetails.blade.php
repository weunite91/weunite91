                                    ...
                                    <div id="biography" >
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 col-6"> <strong>Location</strong>
                                                <br>
                                                <p class="text-muted">{{ $userdetails[0]->cityname }},{{ $userdetails[0]->statename }},{{ $userdetails[0]->countryname }} - {{ $userdetails[0]->pincode }}</p>
                                            </div>
                                            <div class="col-md-6 col-6 b-r"> <strong>Designation</strong>
                                                <br>
                                                <p class="text-muted">{{ $userdetails[0]->de_designation }}</p>
                                            </div>
                                            <div class="col-md-6 col-6"> <strong>Address</strong>
                                                <br>
                                        ...
                                        <h4 class="font-bold">User Introduction</h4>
                                        <hr>
