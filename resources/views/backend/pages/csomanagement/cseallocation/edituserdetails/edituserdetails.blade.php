                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane" id="tab2">
                                    <div id="biography" >
                                        ...
                                        <div class="row">
                                            <div class="card-body " id="bar-parent1">
                                                <form method="post" action="{{ route('edit-fund-detail-cse',$user_id)}}" enctype="multipart/form-data" id="editFRcompanydetails-form">{{ csrf_field() }}
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                ...
                                <div class="tab-pane" id="tab3">
                                    <div id="biography" >
                                        ...
                                        <div class="row">
                                            <div class="card-body " id="bar-parent1">
                                                <form method="post" action="{{ route('edit-fund-payment-cse',$user_id)}}" enctype="multipart/form-data" id="editFRpayment-form">{{ csrf_field() }}
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
