                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" value="{{$userdetails[0]->min_investment_accepated}}" name="min_accepted" minlength="5" maxlength="11" id="min_accepted" placeholder="Min Investment Accepted">
                                                            </div> 
                                                        </div>
                                                    </div>
