                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <select multiple class="form-control select2-hidden-accessible" name="interestin[]" id="interestin" tabindex="-1" aria-hidden="true">
                                                                    ...
                                                                    <option value="Early" {{ in_array('Early',$tempInterest) ? 'selected="selected"' : '' }}>Early</option>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                           <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" name="min_investment" id="min_investment" placeholder="Min Investment Offered" value="{{ $userdetails[0]->min_investment != null ? $userdetails[0]->min_investment : '' }}">
                                                            </div> 
                                                        </div>
                                                        <div class="col-md-6">
                                                           <div class="form-group">
                                                                <label for="max_investment">Max Investment</label>
                                                                <input type="text" class="form-control" name="max_investment" id="max_investment" placeholder="Max Investment Offered" value="{{ $userdetails[0]->max_investment != null ? $userdetails[0]->max_investment : '' }}">
                                                            </div> 
                                                        </div>
                                                    </div>
