                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane" id="tab2">
                                    <div id="biography" >
                                        ...
                                        <div class="row">
                                            <div class="card-body " id="bar-parent1">
                                                <form method="post" action="{{ route('edit-fund-detail-staff',$user_id)}}" enctype="multipart/form-data" id="editFRcompanydetails-form">{{ csrf_field() }}
                                ...
                                <div class="tab-pane" id="tab3">
                                    <div id="biography" >
                                        ...
                                        <div class="row">
                                            <div class="card-body " id="bar-parent1">
                                                <form method="post" action="{{ route('edit-fund-payment-staff',$user_id)}}" enctype="multipart/form-data" id="editFRpayment-form">{{ csrf_field() }}
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label for="simpleFormEmail">Payment Amount</label>
                                                                <select class="form-control select2-hidden-accessible" name="amount" id="amount" tabindex="-1" aria-hidden="true">
