...
<div class="main-container">
    ...
    <div class="progressbar profile-progress" style="margin-top: 70px">
        ...
        <div class="progressbar-intra" data-width="{{round($width)}}">
            <span><b>{{ indian_money_format($totalamount) }}</b><span><b>INR</span></b></span>
        </div>
    </div>
    ...
    <div class="forms">
        <div class="contact-form">	
            ...
            <ul class="steps-btn">
                <li class="active"><a href="{{ route('franchise') }}">Step 1</a></li>
                <li><a href="{{ route('franchise-details') }}">Step 2</a></li>
