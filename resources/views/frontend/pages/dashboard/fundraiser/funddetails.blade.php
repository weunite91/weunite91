...
<div class="main-container">
    ...
    <div class="forms">
        <div class="contact-form">
            ...
            <ul class="steps-btn">
                <li ><a href="{{ route('fund-raiser-dashborad') }}">Step 1</a></li>
                <li class="active"><a href="{{ route('fund-details') }}">Step 2</a></li>
            ...
            <form name="" action="" method="post" enctype="multipart/form-data" id="frdetails">
                ...
                @if($details[0]->first_active=='1')
                    ...
                    <div class="inline-input">
                        Min Investment Required: <br/> INR {{ $details[0]->min_investment != null ? indian_money_format($details[0]->min_investment) : '' }}

                    </div>
                    <div class="inline-input">
                        Max Investment Required: <br/>INR {{ $details[0]->max_investment != null ? indian_money_format($details[0]->max_investment) : '' }}
                    </div>
                    <div class="inline-input">
                        Min Investment Accepted:<br/> INR {{ $details[0]->min_investment_accepated != null ? indian_money_format($details[0]->min_investment_accepated) : '' }}
                    </div>
                ...
                @else
                    ...
                    <div class="inline-input" >
                        ...
                        <input type="text"      class="inrformat"  name="min_investment_dis" id="min_investment_dis" onkeypress="return isNumber(event);" minlength="6" maxlength="15" placeholder="Min Investment Required *" value="{{ $details[0]->min_investment != null ? $details[0]->min_investment : '' }}"/>
                        <input type="hidden" class="nomoneyformat" name="min_investment" id="min_investment" onkeypress="return isNumber(event);" minlength="6" maxlength="11" placeholder="Min Investment Required *" value="{{ $details[0]->min_investment != null ? $details[0]->min_investment : '' }}"/>
                    </div>
                    <div class="inline-input">
                        <label>Max Investment Amount</label>
                        <input type="text"  class="inrformat"      name="max_investment_dis" id="max_investment_dis" onkeypress="return isNumber(event);" minlength="6" maxlength="15" placeholder="Max Investment Required *"  value="{{ $details[0]->max_investment != null ? $details[0]->max_investment : '' }}"/>
                        <input type="hidden" class="nomoneyformat" name="max_investment" id="max_investment" onkeypress="return isNumber(event);" minlength="6" maxlength="11" placeholder="Max Investment Required *"  value="{{ $details[0]->max_investment != null ? $details[0]->max_investment : '' }}"/>
                    </div>
                    @if($details[0]->first_active=='1' && $details[0]->min_investment_accepated != null )
                        <div class="inline-input">
                            <input type="text" class="inrformat"  name="min_accepted_dis" id="min_accepted_dis" minlength="5" maxlength="15" onkeypress="return isNumber(event);" id="min_accepted" placeholder="Min Investment Accepted"  value="{{ $details[0]->min_investment_accepated != null ? $details[0]->min_investment_accepated : '' }}"/>
                            <input type="hidden" class="nomoneyformat" name="min_accepted" id="min_accepted" minlength="5" maxlength="11" onkeypress="return isNumber(event);" id="min_accepted" placeholder="Min Investment Accepted"  value="{{ $details[0]->min_investment_accepated != null ? $details[0]->min_investment_accepated : '' }}"/>
                        </div>
                    @endif
                ...
                <div class="inline-input" style="margin-left: 20px;">
                    <input type="text" name="member1" id="member1" onkeypress="return alphaOnly(event);" placeholder="Team Member 1 *(COMPULSORY)" maxlength="30" value="{{ $details[0]->team_mem1 != null ? $details[0]->team_mem1 : '' }}"/>
                </div>
                ...
                <div class="block-area">
                    <label>Upload Picture of your team member(NOT COMPULSORY)</label>
...
<!--
                ...
                <div class="kpi-table" style="margin-left: 18px;margin-right: 10px;">
                    <div class="kpi-table-intra">
                        <div class="inline-input contact-no">
                            <label>
                                Return ON Investment (ROI)<br>(NOT COMPULSORY)
                            </label>
                        ...
                        <div class="inline-input contact-no">
                            <label>
                                Cost of Capital (Offered)<br>(NOT COMPULSORY)
                            </label>
                        ...
                        <div class="inline-input contact-no">
                            <label>
                                Promotors Investment<br>(NOT COMPULSORY)
                            </label>
                        ...
                        <div class="inline-input contact-no">
                            <label>
                                Assured Minimum Dividend<br>(NOT COMPULSORY)
                            </label>
                        ...
                        <div class="inline-input contact-no">
                            <label>
                                Fixed Assests<br>(NOT COMPULSORY)
                            </label>
                        ...
                        <div class="inline-input contact-no">
                            <label>
                                EBITDA<br>(NOT COMPULSORY)
                            </label>
                            <input type="number" id="ebitda" name="ebitda" maxlength="3"   value="{{ $details[0]->ebitda != null ? $details[0]->ebitda : '' }}"  placeholder="%" />
                        </div>
                        <center>
                            <p><b>For any kind of financial assistant please <a href="#" data-toggle="modal" data-target="#kpiModal" style="color: blue"> click here </a></b></p>
                        </center>
                    </div>
                </div>-->
...
<div class="modal fade product_view bd-example-modal-xl" id="myModal">
                                ...
                                <div class="table-div detailed-pitch-idea">
                                    ...
                                    <div class="table-cell dpi-idea-r">
                                        ...
                                        <div class="videoBorder">
                                            ...
                                            @else
                                            <video width="400" controls>
                                                <source id="pre_video_change"  type="video/webm">
                                                Your browser does not support HTML5 video.
                                            </video>
                                            @endif
                                        </div>
